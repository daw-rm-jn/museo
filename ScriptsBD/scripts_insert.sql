...
INSERT INTO Copia_Cuadro(idCopia_Cuadro,nombreProducto,autor,estilo,orientacion,anioCuadro,fechaAlta,descripcion,precio,fotoCuadro) VALUES (1,'Crucifixión de San Pedro','Michelangelo Merisi da Caravaggio','Barroco','vertical','1601',NOW(),'',100,'Crucifixion de San Pedro.jpg');
INSERT INTO Copia_Cuadro(idCopia_Cuadro,nombreProducto,autor,estilo,orientacion,anioCuadro,fechaAlta,descripcion,precio,fotoCuadro) VALUES (2,'On White II','Vasili Kandinski','Expresionismo','vertical','1923',NOW(),'',82,'On White II.jpg');
INSERT INTO Copia_Cuadro(idCopia_Cuadro,nombreProducto,autor,estilo,orientacion,anioCuadro,fechaAlta,descripcion,precio,fotoCuadro) VALUES (3,'Las señoritas de Avignon','Pablo Picasso','Cubismo','vertical','1907',NOW(),'',200,'Las señoritas de Avignon.jpg');
